          ...
          <div className="header" id="home">
            <div className="container">
              <ul>
                ...
                <li>
                  {" "}
                  <Link to="/logout" data-toggle="modal" data-target="#myModal2">
              ...
              <ul>
                <li>
                  ...
                  <Link to="/login" data-toggle="modal" data-target="#myModal">
                    <i className="fa fa-unlock-alt" aria-hidden="true"></i> Sign
                    In{" "}
                  </Link>
                </li>
                <li>
                  {" "}
                  <Link to="register" data-toggle="modal" data-target="#myModal2">
                    <i className="fa fa-pencil-square-o" aria-hidden="true"></i>{" "}
                    Sign Up{" "}
                  </Link>
                </li>
